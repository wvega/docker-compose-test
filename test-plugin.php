<?php
/**
 * Plugin Name: SkyVerge Test Plugin
 * Plugin URI: https://www.woocommerce.com/products/
 * Description: A test plugin to experiment with running tests on Circle CI using a Docker Compose environment
 * Author: SkyVerge
 ...
 *
 * @package   SkyVerge\WooCommerce\TestPlugin
 * @author    SkyVerge
 * @copyright Copyright (c) 2011-2019, SkyVerge, Inc.
 * @license   http://www.gnu.org/licenses/gpl-3.0.html GNU General Public License v3.0
 *
 * Woo: 99999:00000000000000000000000000000000
 */
...
class SV_Test_Plugin_Loader {
	...
	/** @var SV_Test_Plugin_Loader single instance of this class */
	...
	private function load_framework() {
		...
		if ( ! class_exists( '\\SkyVerge\\WooCommerce\\TestPlugin\\' . $this->get_framework_version_namespace() . '\\SV_WC_Plugin' ) ) {
	...
	/**
	 * Displays any admin notices added with \SV_Test_Plugin_Loader::add_admin_notice()
	 *
	 * @internal
	 *
	 * @since 1.0.0
	...
	/**
	 * Gets the main \SV_Test_Plugin_Loader instance.
	 *
	 * Ensures only one instance can be loaded.
	 *
	 * @since 1.0.0
	 *
	 * @return \SV_Test_Plugin_Loader
	 */
...
// fire it up!
SV_Test_Plugin_Loader::instance();
